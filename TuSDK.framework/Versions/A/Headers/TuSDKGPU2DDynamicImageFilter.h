...
#import "TuSDK2DDynamicImageSticker.h"

/**
 GIF贴纸
 @since v3.3.2
 */
@interface TuSDKGPU2DDynamicImageFilter : TuSDKFilter

/**
 贴纸纹理管理对象
 @since v3.3.2
 */
@property (nonatomic,strong) TuSDK2DDynamicImageSticker *stickerImage;
